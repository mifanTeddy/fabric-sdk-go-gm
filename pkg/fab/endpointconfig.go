...
import (
	...
	tls "app/service/fabric-sdk-go-gm/internal/github.com/tjfoc/gmtls"
	"reflect"
	"regexp"
	"strconv"
	"strings"
	...
	"app/service/fabric-sdk-go-gm/pkg/common/errors/multi"
	...
	commtls "app/service/fabric-sdk-go-gm/pkg/core/config/comm/tls"
	"app/service/fabric-sdk-go-gm/pkg/core/config/cryptoutil"
	"app/service/fabric-sdk-go-gm/pkg/core/config/endpoint"
	"app/service/fabric-sdk-go-gm/pkg/core/config/lookup"
	"app/service/fabric-sdk-go-gm/pkg/core/cryptosuite"
	"app/service/fabric-sdk-go-gm/pkg/util/pathvar"
...
func detectDeprecatedNetworkConfig(endpointConfig *EndpointConfig) {
	...
	for _, v := range endpointConfig.networkConfig.Channels {
		if len(v.Orderers) > 0 {
			...
			logger.Warn("visit https://app/service/fabric-sdk-go-gm/blob/master/test/fixtures/config/overrides/local_entity_matchers.yaml for samples")
			break
		}
	}
}
